package com.example.ecommerceapp.data.manager
...
class LocalUserManagerImpl(
    ...
    override suspend fun setUserLogin() {
        application.datastore.edit {
            preferences -> preferences[PreferencesKey.USER_LOGIN] = true
        }
    }

    override suspend fun setUserLogout() {
        application.datastore.edit {
            preferences -> preferences[PreferencesKey.USER_LOGIN] = false
        }
    }
    ...
    object PreferencesKey {
        ...
        val USER_LOGIN = booleanPreferencesKey(name = Constants.USER_LOGIN_NAME)
    }
}